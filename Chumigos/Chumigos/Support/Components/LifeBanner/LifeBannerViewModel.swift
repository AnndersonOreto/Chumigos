...
class LifeBannerViewModel: ObservableObject {
...
extension LifeBannerViewModel: InAppProtocol {
    func didCompletePayment(for product: String) {
        print("ENVIROMENT", environmentManager)
        print("PROFILE", environmentManager?.profile)
        print("LIFEMANAGER", environmentManager?.profile?.lifeManager)
