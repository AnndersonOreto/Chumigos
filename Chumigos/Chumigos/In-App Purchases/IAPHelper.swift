...
extension IAPHelper {
    ...
    // Saves the user’s completion handler for future execution. It then creates and initiates a request to Apple via an SKProductsRequest object.
...
// This extension is used to get a list of products, their titles, descriptions and prices from Apple’s servers
extension IAPHelper: SKProductsRequestDelegate {
    
    // Called when the list is succesfully retrieved
